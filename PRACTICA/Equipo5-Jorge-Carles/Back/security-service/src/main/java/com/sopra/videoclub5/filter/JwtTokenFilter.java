package com.sopra.videoclub5.filter;
...
import com.sopra.videoclub5.service.JwtTokenUtil;
...
public class JwtTokenFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		String username = jwtTokenUtil.getUsernameFromToken(token); // crea variable username con el user sacado del
																	// token

		UserDetails userDetails = usuariDetalsService.loadUserByUsername(username); // crea userdetails con el nombre
																					// del usuario

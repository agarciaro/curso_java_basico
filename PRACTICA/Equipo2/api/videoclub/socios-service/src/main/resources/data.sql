...
INSERT INTO Videoclub2.pelicula_actor (pelicula_id,actor_id,rol) VALUES
(1,1,'PRINCIPAL');

INSERT INTO Videoclub2.pelicula_director (pelicula_id,director_id) VALUES
(1,1);

INSERT INTO Videoclub2.ejemplar (num_ejemplar,estado,pelicula_id) VALUES 
(8,'Bien bonito',1);
